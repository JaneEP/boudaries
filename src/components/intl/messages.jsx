...
export const messages = {
    [LOCALES.ENGLISH]: {
        learn_to: `Hello Vitalik, how are you? ;)`,
        price_display:
    ...
    [LOCALES.RUSSIAN]: {
        learn_to: 'Привет, Виталик, как ты? ;)',
        price_display:
    ...
    [LOCALES.FRENCH]: {
        learn_to: 'Bonjour Vitalik, comment vas-tu ? ;)',
    ...
    [LOCALES.GERMAN]: {
        learn_to: 'Hallo Vitalik, wie geht es dir? ;)',
        price_display:
